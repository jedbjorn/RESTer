...
You should see a **RESTer** tab in the Revit ribbon.
...
**Admin (inside Revit):**
Click the **Tab Creator** button in the RESTer ribbon tab. Build your toolbar profile, then export. The profile saves to the extension and copies to your Desktop for sharing.
